...
public class RoombaProjectX extends JFrame implements WindowListener {
	...
	private void initComponents() {
		...
		jRadioButton3
				.setIcon(new javax.swing.ImageIcon(
						"C:\\Users\\Lucas\\Desktop\\RoombaEGit\\roomba\\Projet Roomba\\resources\\carre.jpg")); // NOI18N
		...
		jRadioButton4
				.setIcon(new javax.swing.ImageIcon(
						"C:\\Users\\Lucas\\Desktop\\RoombaEGit\\roomba\\Projet Roomba\\resources\\cercleChosen.jpg")); // NOI18N
			...
			public javax.swing.Icon getIcon() {
				try {
					return new javax.swing.ImageIcon(
							new java.net.URL(
									"file:/C:/Users/Lucas/Desktop/RoombaEGit/roomba/Projet Roomba/resources/rectangle.jpg"));
		...
		jRadioButton6.setText("Ar�ne Carr�e");
		...
		jRadioButton7.setText("Ar�ne Circulaire");
		...
		jLabel6.setText("Capteurs suppl�mentaires : ");
	...
	public class RoombaPanel extends JPanel implements MouseListener,
		...
		private void paintRoomba(Graphics2D g2, int facteurEchelle) {
			...
			g2.drawLine(x, y,
					x + (int) (d / 2 * Math.cos(roomba.posture.getTheta())),
					y + (int) (d / 2 * Math.sin(roomba.posture.getTheta())));
		}
